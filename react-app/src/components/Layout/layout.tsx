...
import {
  CreateToastEvent,
  CreateToastEventData,
} from "@kvalitetsit/hjemmebehandling/Events/CreateToastEvent";
    ...
    return (
      <>
        <Box>
          ...
          />
          <ErrorBoundary
            ekstraText="Fejlen der opstod kræver opdatering af siden (F5)"
                  ...
                  >
                    {this.state.createToastData ? (
                      <Toast
                        ...
                        icon={<CheckmarkIcon color="white" size="2rem" />}
                        positionVertical="top"
                        positionhorizontal="center"
                        snackbarTitle={this.state.createToastData.title}
                        snackbarColor="error"
                      ></Toast>
                    ) : (
                      <></>
                    ...
                    <Switch>
                      <Route
                        path="/questionnaire/:questionnaireId/response/:questionnaireResponseId"
                        render={(props) => (
                          <QuestionnaireResponseDetailsPage {...props} />
                        )}
                      />
                      <Route
                        path="/questionnaire/:questionnaireId/answer"
                        render={(props) => (
                          <QuestionnaireResponseCreationPage {...props} />
                        )}
                      />
                      <Route
                        path="/questionnaire/answered"
                        render={(props) => <AnsweredPage {...props} />}
                      />
                      <Route
                        path="/measurements"
                        render={(props) => <ObservationPage {...props} />}
                      />
                      <Route
                        path="/contact"
